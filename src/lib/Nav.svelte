...
<div
		class="fixed flex top-0 z-40 w-full border-slate-200 border-b  bg-white flex-none lg:z-50"
	>
		<a href="/" class="flex py-2 pb-3 top-0 z-60 bg-slate-600 left-0 border-r px-[20px]">
		...
		<div class="flex flex-grow">
			<div class="p-3 lg:px-8 flex flex-grow dark:border-slate-300 mx-4 lg:mx-0">
				<div class="relative flex items-center">
					
					<div class="hidden relative">
						<button
							class="text-xs leading-5 font-semibold rounded-full py-0 px-0 -mt-3 flex items-center space-x-2 hover:bg-slate-400/20"
							type="button"
							aria-haspopup="true"
							aria-expanded="false"
						>
					...
					<div class="relative lg:flex float-right ml-auto">
						<nav class="text-sm leading-6 font-semibold text-black">
							<ul class="flex space-x-8">
									
									<li>
										<span
											class="text-xs text-sky-900/80 font-normal font- p-0.5 py-0 px-2 m-2 -mt-1"
											>{$userStore.email}</span
										>
									</li>
									<li>
										<a
											class=" text-sky-500/90 dark:text-sky-500 hover:text-black-500 dark:hover:text-black-400"
											href="/logout"
										>
	...
	<div
	class="fixed top-12 bottom-[0px] z-40 right-auto  w-[70px] border-slate-200 border-b  bg-slate-500 flex-none lg:z-50"
>
<a href="/documents" class="flex px-5 py-2">
	<Fa icon={faFileLines} secondaryOpacity={1} class="text-slate-300 text-3xl mt-2" />
</a>
<a href="/contracts" class="flex px-5 py-2">
	<Fa icon={faFileContract} secondaryOpacity={1} class="text-slate-300 text-3xl mt-2" />
</a>
				...
				<div class="relative flex items-center">
					<a class="mr-3 flex-none overflow-hidden" href="/">
						...
						<svg width="40" height="42" viewBox="0 0 40 42" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M23.1686 14.5037H19.8588L15.4457 17.252V20.3439L19.8588 17.252V30.9936H23.1686V14.5037Z" fill="#0796FD"/>
							<path d="M3.20754 14.6402C4.08831 13.1201 6.13347 12.0641 6.13347 12.0641C6.13347 12.0641 5.20802 12.6718 4.90876 14.1777C4.60949 15.6836 4.78677 18.8407 4.78677 18.8407C4.78677 18.8407 5.05939 22.328 7.01989 27.8494C7.94601 30.4576 10.2327 35.1672 12.4105 36.3558C14.5883 37.5445 16.7252 37.3197 21.9242 36.2624L26.6877 34.9673C26.6877 34.9673 28.389 34.5048 31.3559 33.3421C34.3229 32.1793 35.2483 31.5716 35.2483 31.5716C35.2483 31.5716 34.5781 32.3907 34.4182 32.5096C34.2583 32.6284 33.456 33.732 30.0359 35.1255C26.6159 36.5191 24.6872 36.9358 24.6872 36.9358C21.1303 37.9028 17.3205 39.1341 13.6086 39.2354C9.85984 39.3377 6.5853 36.5149 4.29789 28.5894C3.27289 25.038 1.02416 18.4084 3.20754 14.6402Z" fill="#0796FD"/>
							<path d="M14.5711 6.4685C14.5711 6.4685 24.5222 3.05771 28.8634 6.61105C41.8176 8.08481 35.8291 14.0345 33.6761 18.6558C34.9816 22.7731 35.555 25.3544 33.4268 22.3545C32.7185 21.3561 33.0182 20.068 33.6761 18.6558C32.7565 15.7556 31.4737 12.0932 30.516 9.08246C30.1789 8.0227 29.6024 7.21596 28.8634 6.61105C25.5049 6.22896 20.8731 6.14773 14.5711 6.4685Z" fill="#0796FD"/>
							</svg>
